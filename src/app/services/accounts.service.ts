...
export class AccountsService {
  ...
  public accoutbycustomerid(customerId :number):Observable<Array<customerAccountdetails> >{

    return this.http.get<Array<customerAccountdetails>>(this.backendHost+"/accounts/customer/"+customerId);
  }
